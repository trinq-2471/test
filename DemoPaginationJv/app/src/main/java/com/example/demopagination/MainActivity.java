                ...
                if(response!=null && !response.equals("")){
                    ...
                    if(responseArray.length()>0){
                        ...
                        for(int i=0; i < 6 ;i++){
                            ...
                            */
                            modelWarDetails.setName(battleObj.getString("name"));
                            modelWarDetails.setAttacker_king(battleObj.getString("attacker_king"));
                            modelWarDetails.setDefender_king(battleObj.getString("defender_king"));
                            modelWarDetails.setLocation(battleObj.getString("location"));
    ...
    private void loadMore() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                int scrollPosition = listWarDetails.size();
